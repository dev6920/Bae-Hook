...
def main(webhook, name, delay, amount, message, hookDeleter):
    ...
    while True if amount == "inf" else counter < int(amount):
        try:
            data = requests.post(webhook, json={"content": str(message), "name": str(name), "avatar_url": "https://imgur.com/a/od8wZNs"})
            if data.status_code == 204:
                print(f"{colorama.Back.BLACK} {colorama.Fore.WHITE}[+] Sent{colorama.Back.RESET}")
            else:
...
$$ |  $$ |$$  __$$ |$$   ____|      $$ |  $$ |$$ |  $$ |$$ |  $$ |$$  _$$<  
$$$$$$$  |\$$$$$$$ |\$$$$$$$\       $$ |  $$ |\$$$$$$  |\$$$$$$  |$$ | \$$\ 
\_______/  \_______| \_______|      \__|  \__| \______/  \______/ \__|  \__|
                                                                            
                                                                            
                                                           By dev6920 on github                
